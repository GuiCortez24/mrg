...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        ...
        <input type="date" class="form-control" id="final_vigencia" name="final_vigencia">
    </div>
</div>
<div class="row mb-3">
    <div class="col-md-6">
...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="numero" name="numero" placeholder="(00) 00000-0000" required>
    </div>
    <div class="col-md-6">
